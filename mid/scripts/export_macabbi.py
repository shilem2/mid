...
def export_maccabi_to_coco():
    ...
    export_study_id_list(ds, study_id_list, output_dir, n_max_study_id, skip_flipped_anns, img_processing_type, vert_visibility_flag)
...
def export_study_id_list(ds, study_id_list, output_dir, n_max=-1, skip_flipped_anns=True, img_processing_type='adjust_dynamic_range', vert_visibility_flag=0):
